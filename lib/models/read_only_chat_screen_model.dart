class OnlyReadChatScreenModel {
  ...
  factory OnlyReadChatScreenModel.fromJson(Map<String, dynamic> json) =>
      OnlyReadChatScreenModel(
        status: json["status"],
...
class Attribute {
  ...
  factory Attribute.fromJson(Map<String, dynamic> json) => Attribute(
        participantsId: json["participantsId"] == null
            ? []
            : List<ParticipantsId>.from(
                json["participantsId"]!.map((x) => ParticipantsId.fromJson(x))),
        id: json["_id"],
...
enum PublicFileUrl {
  ...
  IMAGES_USERS_171859931211461_P_HAEJ4_NML_AC_UX679_JPG,
  IMAGES_USERS_1719037581320_DOWNLOAD_JPG
}

final publicFileUrlValues = EnumValues({
  "/images/groups/group.png": PublicFileUrl.IMAGES_GROUPS_GROUP_PNG,
  "/images/users/1718260216216-image.jpg":
      PublicFileUrl.IMAGES_USERS_1718260216216_IMAGE_JPG,
  "/images/users/1718599312114-61pHAEJ4NML._AC_UX679_.jpg":
      PublicFileUrl.IMAGES_USERS_171859931211461_P_HAEJ4_NML_AC_UX679_JPG,
  "/images/users/1719037581320-download.jpg":
      PublicFileUrl.IMAGES_USERS_1719037581320_DOWNLOAD_JPG
});
...
enum Id { THE_66614_BDE42049454_ED45_D594, THE_66629_F5_E2_D237_F4255_F46219 }
...
enum Name { AHAD_HOSSAIN_AIMAN, MR_SWAPON }
...
enum Subscription { FREE, WEEKLY }

final subscriptionValues =
    EnumValues({"free": Subscription.FREE, "weekly": Subscription.WEEKLY});
